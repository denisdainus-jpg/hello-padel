...
export function VideoText({
  ...
  // ElementType слишком широк для TS: приводим к типу, принимающему обычные пропсы
  const Component = As as React.ElementType<{ className?: string; children?: React.ReactNode }>
